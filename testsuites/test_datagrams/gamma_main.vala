...
int main(string[] args)
{
    ...
    // Node gamma: pid=890, I=wlan0
    string listen_pathname = "recv_890_wlan0";
    string send_pathname = "send_890_wlan0";
    string ack_mac = "fe:cc:cc:cc:cc:cc";
    ...
    ArrayList<int> mymsgs = new ArrayList<int>.wrap(
        {890001,890002,890003,890004,890005,890006,890007,890008,890009});
