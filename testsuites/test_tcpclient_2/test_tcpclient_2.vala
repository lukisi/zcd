...
void main()
{
     ...
     * A program gets a TcpClient to connect to 169.254.0.1 on port 269, to talk to identity 749723 from identity 123456. Then, it uses the object to transmit a call and get a response. But the string that is passed as source_id is not a valid JSON. Hence the library aborts the program.
     */
